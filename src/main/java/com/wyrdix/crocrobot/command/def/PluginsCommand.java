package com.wyrdix.crocrobot.command.def;
...
import com.wyrdix.crocrobot.plugin.Plugin;
import com.wyrdix.crocrobot.plugin.PluginInfo;
...
public class PluginsCommand extends KCommandImpl {
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        for (Plugin plugin : CroCroBot.getPluginMap().values()) {
